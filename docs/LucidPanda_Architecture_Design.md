...
- [4. 系统分层架构](#4-系统分层架构)
- [5. 数据流设计](#5-数据流设计)
  - [5.1 新闻分析流程](#51-新闻分析流程)
  - [5.2 智能外联与情报采集规范 (New)](#53-智能外联与情报采集规范-new)
...
有关新闻采集、自动分类（A股、黄金、美股）以及关键词过滤的详细逻辑，请参阅专门文档：
👉 [**智能情报采集与分类逻辑 (INTELLIGENCE_INGESTION.md)**](./INTELLIGENCE_INGESTION.md)
