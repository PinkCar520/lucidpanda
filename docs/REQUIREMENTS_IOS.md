# LucidPanda iOS App 需求与系统设计文档 (2026版)

## 1. 项目愿景
LucidPanda 移动端旨在为专业投资者提供一个具备“液态玻璃 (Liquid Glass)”高度沉浸感的地缘政治情报终端。它不仅是 Web 端的延伸，更是深度集成 Apple Intelligence 的主动式预警工具。
