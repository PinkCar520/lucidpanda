        ...
        return VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 12) {
                ...
                VStack(spacing: 2) {
                    ...
                    Text(verbatim: "\(activeAlertsCount)")
                        .font(.system(size: 22, weight: .medium, design: .monospaced))
                        .foregroundStyle(activeAlertsCount > 0 ? Color.Alpha.brand : Color.Alpha.textPrimary)
                        .contentTransition(.numericText()) // 数字变化动画
                }
                .frame(minWidth: 70, idealWidth: 80, maxWidth: 120)
                .frame(height: 64)
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        HStack {
                            Image(systemName: "globe")
                                .font(.system(size: 10))
                            Text(verbatim: "UTC \(utcDateFormatter.string(from: currentTime))")
    ...
    private func filterButton(titleKey: String, mode: DashboardViewModel.FilterMode) -> some View {
        Button {
            ...
            Text(LocalizedStringKey(titleKey))
                ...
                .padding(.vertical, 14)
                .foregroundStyle(viewModel.filterMode == mode ? Color.Alpha.primary : Color.Alpha.textPrimary)
