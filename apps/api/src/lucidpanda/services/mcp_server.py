...
def query_macro_expectation(
    event_title: str, date: str | None = None
) -> dict[str, Any]:
    """
    ...
    return cast(
        dict[str, Any],
        tools.query_macro_expectation(event_title=event_title, date_str=date),
    )
...
def compute_expectation_gap(
    ...
    """
    return {
        "expectation_gap": tools.compute_expectation_gap(
            actual, forecast, historical_std
        )
    }
