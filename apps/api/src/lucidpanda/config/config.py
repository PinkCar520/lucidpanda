...
class Settings:
    ...
    DASHSCOPE_EMBEDDING_DIMENSIONS = int(os.getenv("DASHSCOPE_EMBEDDING_DIMENSIONS", 768))
    ...
    # 风险风控
    RISK_DEVICE_MISMATCH_FORCE_REAUTH = os.getenv("RISK_DEVICE_MISMATCH_FORCE_REAUTH", "true").lower() == "true"
    RISK_IP_CHANGE_FORCE_REAUTH = os.getenv("RISK_IP_CHANGE_FORCE_REAUTH", "true").lower() == "true"
